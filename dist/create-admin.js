...
function createAdmin() {
    return __awaiter(this, void 0, void 0, function () {
        var email, password, hashedPassword, existing, updated, admin;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    email = 'admin@caste.com';
                    password = 'admin123';
                ...
                case 2:
                    ...
                    return [4 /*yield*/, prisma.user.update({
                            where: { email: email },
                            data: __assign({ role: 'ADMIN', emailVerified: new Date() }, (existing.password ? {} : { password: hashedPassword }))
                        })];
                case 3:
                    updated = _a.sent();
